...
{if $LINEITEM_FIELDS['no_warranty_card']}
	{assign var=NO_WARRANTY_CARD_EDITABLE value=$LINEITEM_FIELDS['no_warranty_card']->isEditable()}
{if $NO_WARRANTY_CARD_EDITABLE}{assign var=COL_SPAN2 value=($COL_SPAN2)+1}{/if}
{/if}

{if $LINEITEM_FIELDS['serialno']}
	{assign var=SERIALNO_EDITABLE value=$LINEITEM_FIELDS['serialno']->isEditable()}
{if $SERIALNO_EDITABLE}{assign var=COL_SPAN2 value=($COL_SPAN2)+1}{/if}
{/if}
...
{if $LINEITEM_FIELDS['delivery_date']}
	{assign var=DELIVERY_DATE_EDITABLE value=$LINEITEM_FIELDS['delivery_date']->isEditable()}
{if $DELIVERY_DATE_EDITABLE}{assign var=COL_SPAN2 value=($COL_SPAN2)+1}{/if}
{/if}

{if $LINEITEM_FIELDS['inr_rate']}
	{assign var=INR_RATE_EDITABLE value=$LINEITEM_FIELDS['inr_rate']->isEditable()}
{if $INR_RATE_EDITABLE}{assign var=COL_SPAN2 value=($COL_SPAN2)+1}{/if}
{/if}



{if $LINEITEM_FIELDS['productcode']}
	{assign var=PRODUCTCODE_EDITABLE value=$LINEITEM_FIELDS['productcode']->isEditable()}
{if $PRODUCTCODE_EDITABLE}{assign var=COL_SPAN2 value=($COL_SPAN2)+1}{/if}
{/if}

{if $LINEITEM_FIELDS['itemunit']}
	{assign var=ITEMUNIT_EDITABLE value=$LINEITEM_FIELDS['itemunit']->isEditable()}
{if $ITEMUNIT_EDITABLE}{assign var=COL_SPAN2 value=($COL_SPAN2)+1}{/if}
{/if}
			...
			<div class="row">
							...
							{if $LINEITEM_FIELDS['region_id'] && $LINEITEM_FIELDS['region_id']->isEditable()}
								<span class="pull-right">
									...
									<select class="select2" id="region_id" name="region_id" style="width: 164px;">
										<option value="0" data-info="{arocrm_Util_Helper::toSafeHTML(Zend_Json::encode($DEFAULT_TAX_REGION_INFO))}">{vtranslate('LBL_SELECT_OPTION', $MODULE)}</option>
										{foreach key=TAX_REGION_ID item=TAX_REGION_INFO from=$TAX_REGIONS}
											<option value="{$TAX_REGION_ID}" data-info='{arocrm_Util_Helper::toSafeHTML(Zend_Json::encode($TAX_REGION_INFO))}' {if $TAX_REGION_ID eq $RECORD->get('region_id')}selected{/if}>{$TAX_REGION_INFO['name']}</option>
										{/foreach}
									</select>
									<input type="hidden" id="prevRegionId" value="{$RECORD->get('region_id')}" />
									&nbsp;&nbsp;<a class="fa fa-wrench" href="index.php?module=arocrm&parent=Settings&view=TaxIndex" target="_blank" style="vertical-align:middle;"></a>
								</span>
							{/if}
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4" style="top: 3px;">
					<center>
						...
						<input type="number" name="inr_exchange_rate" class="inputElement" style="max-width:50px;" id="inr_exchange_rate" value="1"  min="1" step="any"/>
							{/if}
				...
				<table class="table table-bordered" id="lineItemTab">
					<tr>
						...
						{/if}
							...
							<td>
								<strong class="pull-right" style="float:left!important;">Item Code</strong>
							</td>
						   
							<td>
								<strong class="pull-right" style="float:left!important;">Unit</strong>
							</td>
						...
						{if $MODULE eq 'Invoice'}
								...
								<td>
									<strong class="pull-right" style="float:left!important;">Serial Number</strong>
								</td>
		...
		<div class="fieldBlockContainer">
				...
				{if $DISCOUNT_AMOUNT_EDITABLE || $DISCOUNT_PERCENT_EDITABLE}
					<tr>
						...
						<td>
							...
							<!-- Popup Discount Div -->
							{if $MODULE eq 'SalesOrder' or $MODULE eq 'Invoice'}
				<div id="finalDiscountUI" class="finalDiscountUI validCheck hide">
					<div id="staticDiscount">
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupMonthlyTable">
						<thead><tr><th colspan="2"> Monthly Discount </th></tr></thead>
						<tbody>
						<!--<tr>
							<td>Per Unit:</td><td><input type="number" id="overallmonthlycashamount" name="overallmonthlycashamount" style="width: 50px;"></td>
							<td>Total:</td><td><input type="number" id="totaloverallmonthlycashamount" name="totaloverallmonthlycashamount" style="width: 50px;"></td>
						</tr>
						<tr>
							<td>Cash</td><td><input type="number" id="overallmonthlycashpercent" name="overallmonthlycashpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallmonthlycashpercentval" name="overallmonthlycashpercentval" style="width: 50px;"></td>
						</tr>-->
						<tr>
							<td>Target</td><td><input type="number" id="overallmonthlytargetpercent" name="overallmonthlytargetpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallmonthlytargetpercentval" name="overallmonthlytargetpercentval" style="width: 80px;"></td>
						</tr>
						<!--<tr>
							<td>Retailer</td><td><input type="number" id="overallmonthlyretailerpercent" name="overallmonthlyretailerpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallmonthlyretailerpercentval" name="overallmonthlyretailerpercentval" style="width: 50px;"></td>
						</tr>-->
						</tbody>
					</table>
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupQuarterlyTable">
						<thead><tr><th colspan="2"> Quarterly Discount </th></tr></thead>
						<tbody>
						<!--<tr>
							<td>Per Unit:</td><td><input type="number" id="overallquarterlycashamount" name="overallquarterlycashamount" style="width: 50px;"></td>
							<td>Total:</td><td><input type="number" id="totaloverallquarterlycashamount" name="totaloverallquarterlycashamount" style="width: 50px;"></td>
						</tr>
						<tr>
							<td>Cash</td><td><input type="number" id="overallquarterlycashpercent" name="overallquarterlycashpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallquarterlycashpercentval" name="overallquarterlycashpercentval" style="width: 50px;"></td>
						</tr>-->
						<tr>
							<td>Target</td><td><input type="number" id="overallquarterlytargetpercent" name="overallquarterlytargetpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallquarterlytargetpercentval" name="overallquarterlytargetpercentval" style="width: 50px;"></td>
						</tr>
						<!--<tr>
							<td>Retailer</td><td><input type="number" id="overallquarterlyretailerpercent" name="overallquarterlyretailerpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallquarterlyretailerpercentval" name="overallquarterlyretailerpercentval" style="width: 50px;"></td>
						</tr>-->
						</tbody>
					</table>
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupHalfYearlyTable">
						<thead><tr><th colspan="2"> Half-Yearly Discount </th></tr></thead>
						<tbody>
						<!--<tr>
							<td>Per Unit:</td><td><input type="number" id="overallhalfyearlycashamount" name="overallhalfyearlycashamount" style="width: 50px;"></td>
							<td>Total:</td><td><input type="number" id="totaloverallhalfyearlycashamount" name="totaloverallhalfyearlycashamount" style="width: 50px;"></td>
						</tr>
						<tr>
							<td>Cash</td><td><input type="number" id="overallhalfyearlycashpercent" name="overallhalfyearlycashpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallhalfyearlycashpercentval" name="overallhalfyearlycashpercentval" style="width: 50px;"></td>
						</tr>-->
						<tr>
							<td>Target</td><td><input type="number" id="overallhalfyearlytargetpercent" name="overallhalfyearlytargetpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallhalfyearlytargetpercentval" name="overallhalfyearlytargetpercentval" style="width: 80px;"></td>
						</tr>
						<!--<tr>
							<td>Retailer</td><td><input type="number" id="overallhalfyearlyretailerpercent" name="overallhalfyearlyretailerpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallhalfyearlyretailerpercentval" name="overallhalfyearlyretailerpercentval" style="width: 50px;"></td>
						</tr>-->
						</tbody>
					</table>
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupAnnuallyTable">
						<thead><tr><th colspan="2"> Annually Discount </th></tr></thead>
						<tbody>
						<!--<tr>
							<td>Per Unit:</td><td><input type="number" id="overallannuallycashamount" name="overallannuallycashamount" style="width: 50px;"></td>
							<td>Total:</td><td><input type="number" id="totaloverallannuallycashamount" name="totaloverallannuallycashamount" style="width: 50px;"></td>
						</tr>
						<tr>
							<td>Cash</td><td><input type="number" id="overallannuallycashpercent" name="overallannuallycashpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallannuallycashpercentval" name="overallannuallycashpercentval" style="width: 50px;"></td>
						</tr>-->
						<tr>
							<td>Target</td><td><input type="number" id="overallannuallytargetpercent" name="overallannuallytargetpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallannuallytargetpercentval" name="overallannuallytargetpercentval" style="width: 80px;"></td>
						</tr>
						<!--<tr>
							<td>Retailer</td><td><input type="number" id="overallannuallyretailerpercent" name="overallannuallyretailerpercent" style="width: 50px;">%</td>
							<td></td><td><input type="number" id="overallannuallyretailerpercentval" name="overallannuallyretailerpercentval" style="width: 50px;"></td>
						</tr>-->
						</tbody>
					</table>
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupPaymentTable">
						<thead><tr><th colspan="2"> Payment-wise Discount </th></tr></thead>
						<tbody>
							<tr>
								<td>Advance Payment</td><td><input type="number" id="overalladvancepercent" name="overalladvancepercent" style="width: 50px;">%</td>
								<td></td><td><input type="number" id="overalladvancepercentval" name="overalladvancepercentval" style="width: 60px;"></td>
							</tr>
							<tr>
								<td>Cheque Pay on Invoice Date</td><td><input type="number" id="overallsamedaypercent" name="overallsamedaypercent" style="width: 50px;">%</td>
								<td></td><td><input type="number" id="overallsamedaypercentval" name="overallsamedaypercentval" style="width: 60px;"><input type="hidden" id="samedayInvoiceId" name="samedayInvoiceId" value=""></td>
							</tr>
							<tr>
								<td>Cash Pay on Invoice Date</td><td><input type="number" id="overallsamedaycashpercent" name="overallsamedaycashpercent" style="width: 50px;">%</td>
								<td></td><td><input type="number" id="overallsamedaycashpercentval" name="overallsamedaycashpercentval" style="width: 60px;"><input type="hidden" id="samedaycashInvoiceId" name="samedaycashInvoiceId" value=""></td>
							</tr>
							<tr>
								<td>Pay Within 7 Days</td><td><input type="number" id="overall7dayspercent" name="overall7dayspercent" style="width: 50px;">%</td>
								<td></td><td><input type="number" id="overall7dayspercentval" name="overall7dayspercentval" style="width: 60px;"><input type="hidden" id="within7daysInvoiceId" name="within7daysInvoiceId" value=""></td>
							</tr>
							<tr>
								<td>Pay within 15 Days</td><td><input type="number" id="overall15dayspercent" name="overall15dayspercent" style="width: 50px;">%</td>
								<td></td><td><input type="number" id="overall15dayspercentval" name="overall15dayspercentval" style="width: 60px;"><input type="hidden" id="within15daysInvoiceId" name="within15daysInvoiceId" value=""></td>
							</tr>
							<tr>
								<td>Pay within 30 Days</td><td><input type="number" id="overall30dayspercent" name="overall30dayspercent" style="width: 50px;">%</td>
								<td></td><td><input type="number" id="overall30dayspercentval" name="overall30dayspercentval" style="width: 60px;"><input type="hidden" id="within30daysInvoiceId" name="within30daysInvoiceId" value=""></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div id="dynamicDiscount" class="hide">
							...
							<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupTable">
								{foreach item=tax_detail name=group_tax_loop key=loop_count from=$TAXES}
									<tr>
										...
										<td class="lineOnTop">
											<input type="text" size="5" data-compound-on="{if $tax_detail['method'] eq 'Compound'}{arocrm_Util_Helper::toSafeHTML(Zend_Json::encode($tax_detail['compoundon']))}{/if}"
			...
			<span class="pull-right">(+)&nbsp;<strong><a href="javascript:void(0)" id="chargeTaxes">{vtranslate('LBL_TAXES_ON_CHARGES',$MODULE)} </a></strong></span>
				...
				{if $MODULE eq 'SalesOrder' or $MODULE eq 'Invoice'}
					<tr valign="top">
						<td width="83%">
							<span class="pull-left" id="scheme"></span>
							<span class="pull-right"><strong>Scheme Discount</strong></span>
						</td>
						<td>
							<input id="schemediscount" name="schemediscount" type="number" class="pull-right schemediscount" value="0" min="0">
						</td>
					</tr>
				{/if}
				{if $MODULE eq 'SalesOrder' or $MODULE eq 'PurchaseOrder' or $MODULE eq 'Invoice'}
					<tr valign="top">
						<td width="83%">
							<span class="pull-left" id="adv"></span>
							<span class="pull-right"><strong>Advance Payment</strong></span>
						</td>
						<td>
							<input id="advancePayment" name="advancePayment" type="text" class="pull-right advancePayment" value="0">
							<input id="advPayment" name="advPayment" type="hidden" class="pull-right advPayment" value="">
							<input id="ap" name="ap" type="hidden" class="pull-right ap" value="">
						</td>
					</tr>
					<!--<tr valign="top">
						<td width="83%">
							<span class="pull-left" id="dnote"></span>
							<span class="pull-right"><strong>Debit Note</strong></span>
						</td>
						<td>
							<input id="debit" name="debit" type="text" class="pull-right deb" value="0">
							<input id="deb" name="deb" type="hidden" class="pull-right deb" value="">
							<input id="dn" name="dn" type="hidden" class="pull-right dn" value="">
						</td>
					</tr>-->
					<tr valign="top">
						<td width="83%">
							<span class="pull-left" id="cnote"></span>
							<span class="pull-right"><strong>Credit Note</strong></span>
						</td>
						<td>
							<input id="credit" name="credit" class="pull-right credit" value="0">
							<input id="cre" name="cre" type="hidden" class="pull-right cre" value="">
							<input id="cn" name="cn" type="hidden" class="pull-right cn" value="">
						</td>
					</tr>
				{/if}
				<tr valign="top">
				...
				{if $MODULE eq 'Invoice' or $MODULE eq 'PurchaseOrder' or $MODULE eq 'SalesOrder'}
					<!--<tr valign="top">
						<td width="83%" >
							<div class="pull-right">
								{if $MODULE eq 'Invoice' or $MODULE eq 'PurchaseInvoice'}
					...
					<tr valign="top">
						...
						<td>
							<input id="received_amount" name="received_amount" type="hidden" class="lineItemInputBox form-control" value="0" />
						<input id="actual_balance" name="actual_balance" type="hidden" class="lineItemInputBox form-control" value="0" />
